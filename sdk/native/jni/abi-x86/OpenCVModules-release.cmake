...
list(APPEND _cmake_import_check_files_for_libcpufeatures "${_IMPORT_PREFIX}/sdk/native/3rdparty/libs/x86/libcpufeatures.a" )
...
list(APPEND _cmake_import_check_files_for_libjpeg-turbo "${_IMPORT_PREFIX}/sdk/native/3rdparty/libs/x86/liblibjpeg-turbo.a" )
...
list(APPEND _cmake_import_check_files_for_libtiff "${_IMPORT_PREFIX}/sdk/native/3rdparty/libs/x86/liblibtiff.a" )
...
list(APPEND _cmake_import_check_files_for_libwebp "${_IMPORT_PREFIX}/sdk/native/3rdparty/libs/x86/liblibwebp.a" )
...
list(APPEND _cmake_import_check_files_for_libopenjp2 "${_IMPORT_PREFIX}/sdk/native/3rdparty/libs/x86/liblibopenjp2.a" )
...
list(APPEND _cmake_import_check_files_for_libpng "${_IMPORT_PREFIX}/sdk/native/3rdparty/libs/x86/liblibpng.a" )
...
list(APPEND _cmake_import_check_files_for_IlmImf "${_IMPORT_PREFIX}/sdk/native/3rdparty/libs/x86/libIlmImf.a" )
...
list(APPEND _cmake_import_check_files_for_tbb "${_IMPORT_PREFIX}/sdk/native/3rdparty/libs/x86/libtbb.a" )
...
list(APPEND _cmake_import_check_files_for_ippiw "${_IMPORT_PREFIX}/sdk/native/3rdparty/libs/x86/libippiw.a" )
...
list(APPEND _cmake_import_check_files_for_libprotobuf "${_IMPORT_PREFIX}/sdk/native/3rdparty/libs/x86/liblibprotobuf.a" )
...
list(APPEND _cmake_import_check_files_for_quirc "${_IMPORT_PREFIX}/sdk/native/3rdparty/libs/x86/libquirc.a" )
...
list(APPEND _cmake_import_check_files_for_ittnotify "${_IMPORT_PREFIX}/sdk/native/3rdparty/libs/x86/libittnotify.a" )
...
list(APPEND _cmake_import_check_files_for_ade "${_IMPORT_PREFIX}/sdk/native/3rdparty/libs/x86/libade.a" )
...
list(APPEND _cmake_import_check_files_for_opencv_flann "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86/libopencv_flann.a" )
...
list(APPEND _cmake_import_check_files_for_opencv_intensity_transform "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86/libopencv_intensity_transform.a" )
...
list(APPEND _cmake_import_check_files_for_opencv_ml "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86/libopencv_ml.a" )
...
list(APPEND _cmake_import_check_files_for_opencv_phase_unwrapping "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86/libopencv_phase_unwrapping.a" )
...
list(APPEND _cmake_import_check_files_for_opencv_plot "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86/libopencv_plot.a" )
...
list(APPEND _cmake_import_check_files_for_opencv_quality "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86/libopencv_quality.a" )
...
list(APPEND _cmake_import_check_files_for_opencv_reg "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86/libopencv_reg.a" )
...
list(APPEND _cmake_import_check_files_for_opencv_surface_matching "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86/libopencv_surface_matching.a" )
...
list(APPEND _cmake_import_check_files_for_opencv_xphoto "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86/libopencv_xphoto.a" )
...
list(APPEND _cmake_import_check_files_for_opencv_dnn "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86/libopencv_dnn.a" )
...
list(APPEND _cmake_import_check_files_for_opencv_dnn_superres "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86/libopencv_dnn_superres.a" )
...
list(APPEND _cmake_import_check_files_for_opencv_fuzzy "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86/libopencv_fuzzy.a" )
...
list(APPEND _cmake_import_check_files_for_opencv_hfs "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86/libopencv_hfs.a" )
...
list(APPEND _cmake_import_check_files_for_opencv_img_hash "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86/libopencv_img_hash.a" )
...
list(APPEND _cmake_import_check_files_for_opencv_imgcodecs "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86/libopencv_imgcodecs.a" )
...
list(APPEND _cmake_import_check_files_for_opencv_line_descriptor "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86/libopencv_line_descriptor.a" )
...
list(APPEND _cmake_import_check_files_for_opencv_saliency "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86/libopencv_saliency.a" )
...
list(APPEND _cmake_import_check_files_for_opencv_text "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86/libopencv_text.a" )
...
list(APPEND _cmake_import_check_files_for_opencv_videoio "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86/libopencv_videoio.a" )
...
list(APPEND _cmake_import_check_files_for_opencv_wechat_qrcode "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86/libopencv_wechat_qrcode.a" )
...
list(APPEND _cmake_import_check_files_for_opencv_barcode "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86/libopencv_barcode.a" )
...
list(APPEND _cmake_import_check_files_for_opencv_calib3d "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86/libopencv_calib3d.a" )
...
list(APPEND _cmake_import_check_files_for_opencv_datasets "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86/libopencv_datasets.a" )
...
list(APPEND _cmake_import_check_files_for_opencv_mcc "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86/libopencv_mcc.a" )
...
list(APPEND _cmake_import_check_files_for_opencv_objdetect "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86/libopencv_objdetect.a" )
...
list(APPEND _cmake_import_check_files_for_opencv_rapid "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86/libopencv_rapid.a" )
...
list(APPEND _cmake_import_check_files_for_opencv_rgbd "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86/libopencv_rgbd.a" )
...
list(APPEND _cmake_import_check_files_for_opencv_shape "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86/libopencv_shape.a" )
...
list(APPEND _cmake_import_check_files_for_opencv_structured_light "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86/libopencv_structured_light.a" )
...
list(APPEND _cmake_import_check_files_for_opencv_videostab "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86/libopencv_videostab.a" )
...
list(APPEND _cmake_import_check_files_for_opencv_xfeatures2d "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86/libopencv_xfeatures2d.a" )
...
list(APPEND _cmake_import_check_files_for_opencv_ximgproc "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86/libopencv_ximgproc.a" )
...
list(APPEND _cmake_import_check_files_for_opencv_xobjdetect "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86/libopencv_xobjdetect.a" )
...
list(APPEND _cmake_import_check_files_for_opencv_aruco "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86/libopencv_aruco.a" )
...
list(APPEND _cmake_import_check_files_for_opencv_bgsegm "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86/libopencv_bgsegm.a" )
...
list(APPEND _cmake_import_check_files_for_opencv_bioinspired "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86/libopencv_bioinspired.a" )
...
list(APPEND _cmake_import_check_files_for_opencv_ccalib "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86/libopencv_ccalib.a" )
...
list(APPEND _cmake_import_check_files_for_opencv_dnn_objdetect "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86/libopencv_dnn_objdetect.a" )
...
list(APPEND _cmake_import_check_files_for_opencv_dpm "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86/libopencv_dpm.a" )
...
list(APPEND _cmake_import_check_files_for_opencv_face "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86/libopencv_face.a" )
...
list(APPEND _cmake_import_check_files_for_opencv_gapi "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86/libopencv_gapi.a" )
...
list(APPEND _cmake_import_check_files_for_opencv_optflow "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86/libopencv_optflow.a" )
...
list(APPEND _cmake_import_check_files_for_opencv_stitching "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86/libopencv_stitching.a" )
...
list(APPEND _cmake_import_check_files_for_opencv_superres "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86/libopencv_superres.a" )
...
list(APPEND _cmake_import_check_files_for_opencv_tracking "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86/libopencv_tracking.a" )
...
list(APPEND _cmake_import_check_files_for_opencv_stereo "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86/libopencv_stereo.a" )
...
list(APPEND _cmake_import_check_files_for_opencv_java "${_IMPORT_PREFIX}/sdk/native/libs/x86/libopencv_java4.so" )
